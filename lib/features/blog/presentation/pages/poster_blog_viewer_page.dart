...
class PosterBlogViewerPage extends StatelessWidget {
  static const String pageName = '/poster-blog-viewer';
  final Blog blog; //requesting the blog
  const PosterBlogViewerPage({super.key, required this.blog});
